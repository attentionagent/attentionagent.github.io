...
In addition to these works, attentions are also explicitly targeted for interpretability in RL agents.
...
The authors demonstrated that their agents can achieve performance competitive with SOTA models on Atari tasks while still being interpretable.
